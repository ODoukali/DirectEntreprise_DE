...
WebUI.navigateToUrl('http://10.10.1.166:8080/Guichet/')

WebUI.maximizeWindow()

WebUI.click(findTestObject('Object Repository/Page_DirectEntreprise/a_Mon compte'))

WebUI.setText(findTestObject('Object Repository/Page_Authentification/input_Login_j_id41login'), 'alt.yu-fbrimfj@yopmail.com')

WebUI.click(findTestObject('Object Repository/Page_Authentification/label_Mot de passe'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Authentification/input_Mot de passe_j_id41motdepasse'), '9ghG3marKq70PdGAmYnxZA==')
