...
WebUI.callTestCase(findTestCase('Environment de Test/Authentification/Valid User'), [:], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.navigateToUrl(GlobalVariable.Url_Test)
