...
WebUI.setText(findTestObject('Object Repository/ActivationCompte/Page_Authentification/input_Login_j_id41login'), GlobalVariable.CaptureMail)
...
String Text = WebUI.getText(findTestObject('Creation de compte/XpathNeed/VérifierLoginSucces'))

println(Text)

WebUI.verifyElementText(findTestObject('Creation de compte/XpathNeed/VérifierLoginSucces'), 'Espace particulier')
